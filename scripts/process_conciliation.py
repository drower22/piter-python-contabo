...
def main():
    ...
    parser = argparse.ArgumentParser(description='Processa um arquivo de conciliação do iFood.')
    parser.add_argument('--filepath', required=True, help='Caminho para o arquivo a ser processado.')
